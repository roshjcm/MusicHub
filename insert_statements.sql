...
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Private",0,4)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Private",0,5)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,6)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,7)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,8)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,9)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Private",0,10)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,11)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,12)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,13)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Private",0,14)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Private",0,15)
INSERT INTO playlists(name,status,num_songs,libid) values ("My Favorites","Public",0,16)
